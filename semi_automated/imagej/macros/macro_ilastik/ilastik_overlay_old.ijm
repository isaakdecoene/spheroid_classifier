...
run("Import HDF5", "select=[" + image + "] datasetname=[/data: (1, 1, 4474, 4506, 1) uint8] axisorder=tzyxc");

run("Import HDF5", "select=[" + overlay + "] datasetname=[/exported_data: (1, 1, 4474, 4506, 1) unit8] axisorder=tzyxc applylut");
...
run("Scale...", "x=0.15 y=0.15 width=676 height=671 interpolation=Bilinear average create title=[scaled]");
// run("Scale...", "x=0.15 y=0.15 width=676 height=671 interpolation=Bilinear average create title=[scaled]");
